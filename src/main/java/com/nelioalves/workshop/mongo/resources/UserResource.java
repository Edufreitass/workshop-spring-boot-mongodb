...
import com.nelioalves.workshop.mongo.services.UserService;
...
public class UserResource {
	...
	public ResponseEntity<Void> insert(@RequestBody UserDTO objDto) {
		...
		// Retorna uma resposta VAZIA, porém nessa resposta terá um cabeçalho com a URL do novo recurso criado
